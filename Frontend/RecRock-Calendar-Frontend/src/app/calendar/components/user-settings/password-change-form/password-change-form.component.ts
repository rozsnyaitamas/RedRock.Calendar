...
import { NewPasswordCheck, NewPassword, CssClassSnackFail, CssClassSnackSuccess, MsgPasswordChangeFail, MsgPasswordChangeSuccess, OldPassword, SnackActionClose } from '../user-settings.constants';
...
export class PasswordChangeFormComponent implements OnInit {
  ...
  constructor(
    private readonly userService: UserService,private snackBar: MatSnackBar) { }
